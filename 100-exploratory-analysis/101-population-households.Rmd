...
```{r scatterplot}
scatterplot_population_households <-
  population_households %>% 
  mutate(
...
```{r marginal}
marginal_population_households <-
  ggMarginal(
    scatterplot_population_households, 
    type = "histogram",
    fill = "#666666"
...
```{r scatterplot_print, fig.height=8, fig.width=7}
print(scatterplot_population_households)
```

```{r marginal_print, fig.height=8, fig.width=8}
print(marginal_population_households)
```
